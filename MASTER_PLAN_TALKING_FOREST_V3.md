...
graph TD
    ...
    F --> G[Intro Story (Story Engine V3)]
...
║  ├── 📄 story.html               ← Story Engine (Custom V3)               ║
║  │                                                                        ║
...
| `monogatari_integration_plan.md` | **[DEPRECATED]** Replaced by V3 Story Engine  | [ARCHIVED]                                |
...
├── ✅ story.html          ← Story Engine V3 (Custom) [ACTIVE]
...
flowchart TD
    ...
    subgraph STORY["STORY (V3 Engine)"]
...
| 5 Feb 2026  | **PIVOT: V3 Story Engine**    | Replaced Monogatari with custom engine            |
