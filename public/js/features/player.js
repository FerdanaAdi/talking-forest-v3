...
╔══════════════════════════════════════════════════════════════════════════════╗
║                                                                              ║
║   📄 NAMA FILE: js/features/player.js                                        ║
║   🔧 FUNGSI: Manajemen Data Karakter Pemain                                  ║
║   📍 POSISI: Dipakai oleh halaman-halaman game V3                           ║
║   📏 UKURAN: ~75 baris (Kecil)                                               ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
...
File ini mengurus data karakter pemain:
- Nama pemain
- Jenis kelamin (male/female)
- Level dan XP
- Inventaris (koleksi item)
- Badge prestasi
...
🔴 = JANGAN EDIT (hampir semua fungsi)
🟢 = BOLEH EDIT
...
🟢 Baris 47: Default nama pemain ('Ranger Baru')
   Contoh: 'Ranger Baru' → 'Penjelajah'

🟢 Baris 49: Default avatar path
   Contoh: 'assets/images/avatars/bibit.png' → path gambar lain

════════════════════════════════════════════════════════════════════════════════
⚠️ YANG JANGAN DIEDIT
════════════════════════════════════════════════════════════════════════════════

🔴 STORAGE_KEY - Kunci penyimpanan localStorage
🔴 Fungsi: init, load, save, createCharacter, addXp, addToInventory
🔴 Logika localStorage
